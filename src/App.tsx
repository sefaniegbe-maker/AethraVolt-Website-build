  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 rounded-full border border-[#00E5FF]/30 bg-black/30 backdrop-blur-md mb-8">
            <span className="w-2 h-2 rounded-full bg-[#00E5FF] animate-pulse mr-2"></span>
            <span className="text-sm text-[#00E5FF] tracking-widest font-light uppercase">AethraVolt Energy Autonomy</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight tracking-tight drop-shadow-2xl">
            AI+能源驱动的<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00E5FF] to-[#0066FF]">
              “零碳新质生产力”
            </span>
            运营商
          </h1>
